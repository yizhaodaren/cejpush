...
-(void)initUI{
    ...
    //登录按钮
    self.loginButton = [k_factory createButtonWithTiltle:@"注册"];
    self.loginButton.backgroundColor = [UIColor blueColor];
    
    //切换按钮
    self.presentButton = [k_factory createButtonWithTiltle:@"登录"];
